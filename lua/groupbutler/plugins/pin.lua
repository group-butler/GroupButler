...
local function last_pin(self, msg)
	...
	local pin_id = self.red:get("chat:"..msg.chat.id..":pin")
	if pin_id == null then
		msg:send_reply(i18n:_("I couldn't find any message generated by <code>/pin</code>."), "html")
		return
	end
	local ok, err = self.api:send_message{
		chat_id = msg.chat.id,
		text = i18n:_("Last message generated by <code>/pin</code> ^"),
		parse_mode = "html",
		reply_to_message_id = pin_id,
	}
	if not ok and err.description:lower():match("reply message not found") then
		msg:send_reply(i18n:_("The old message generated with <code>/pin</code> does not exist anymore."), "html")
