...
You can find a backup of your Redis database under `/var/redis/dump.rdb`. The name of this file and the frequency of the saves depend on your redis configuration file.
