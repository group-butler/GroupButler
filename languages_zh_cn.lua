    zh_cn = {
        ...
        settings = {
            ...
            char = {
                ...
                arab_allow = '允许阿拉伯语消息',
                rtl_kick = '使用 RTL 字符将导致被移除出群',
                rtl_ban = '使用 RTL 字符将导致被封禁',
                rtl_allow = '允许使用 RTL 字符',
            },
            broken_group = '还没有针对本群的设置。\n请通过执行 /initgroup 指令来解决这一问题 :)',
            Rules = '/rules',
            About = '/about',
            Welcome = '欢迎信息',
            Modlist = '/adminlist',
        ...
        warn = {
            ...
            getwarns_reply = '回复一个用户来检查他收到的警告数量',
            getwarns = '&&&1 (*&&&2/&&&3*)\nMedia: (*&&&4/&&&5*)',
            nowarn_reply = '回复一个用户来删除警告',
            warn_removed = '*警告已删除！*\n_警告数量_   *&&&1*\n_允许上限_   *&&&2*',
            ban_motivation = '警告过多',
		...
		banhammer = {
            ...
            tempban_zero = '对于此需求，你可以直接使用 /ban 指令',
